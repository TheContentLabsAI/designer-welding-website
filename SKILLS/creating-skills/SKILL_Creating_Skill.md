...
description: Expert system for generating high-quality, predictable, and efficient agent skills. Use this skill when the user asks to create a new skill or define a new capability/workflow.
---
